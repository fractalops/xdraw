import { FONT, rectangle, text } from "./elements.js";
import { measureTextWidth } from "./text-metrics.js";
import { highlightSource, sourceFromHighlight } from "./syntax-highlighter.js";
import {
...
export function codeBlockRequiredWidth(block) {
...
function renderPlainSource(drawing, block, position, groupIds) {
...
function renderHighlightedSource(drawing, block, position, lines, groupIds) {
...
export function renderCodeBlock(drawing, block, bounds) {
