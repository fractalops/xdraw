...
/** @typedef {1 | 2 | 3} FontFamily */
/** @type {Record<FontFamily, Record<string, number>>} */
const FONT_METRICS = FONT_ADVANCES;
...
/** @param {string} value @param {FontFamily} fontFamily */
...
/** @param {string | number} value @param {number} fontSize @param {FontFamily} [fontFamily] */
...
/** @param {string} token @param {number} width @param {number} fontSize @param {FontFamily} fontFamily */
...
/** @param {string} value @param {number} width @param {number} fontSize @param {FontFamily} [fontFamily] */
